...
RSpec.describe 'Advanced Nested Collections' do
  ...
  it 'test 7' do
    ...
    # employee_names = stores.map do |stores,data|
    #   data[:employees]
    # end.flatten
    
    
    employee_names = stores.flat_map do |stores,data|
      data[:employees]
    end
  ...
  it 'test 8' do
    ...
    ingredients = stores.flat_map do |stores,data|
      data[:dishes].flat_map do |dish|
